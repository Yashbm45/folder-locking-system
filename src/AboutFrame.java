...
class AboutFrame
{
  ...
  public AboutFrame()
  {
	...
	jprgbar.setForeground(Color.black);                               // Dimention Change
	...
	Name_panel=new JPanel();         //create name panel
    ...
    frame.setBounds((d.width- width)/2, (d.height- height)/2,230,240);       // and disply frame
